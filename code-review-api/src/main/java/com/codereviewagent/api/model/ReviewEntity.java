...
public class ReviewEntity {
    ...
    @Column(nullable = false) public String inputType;
    ...
    @Column(nullable = false) public String ruleSetId;
    public String ruleSetName;
    @Lob public String ruleSnapshotJson;
    @Column(nullable = false) public String status;
    public int scannedFiles;
    public int skippedFiles;
    @Column(length = 2000) public String warning;
    @Column(length = 2000) public String error;
